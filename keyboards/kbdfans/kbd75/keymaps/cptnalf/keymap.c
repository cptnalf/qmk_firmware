...
#define __xxxx_ KC_NO

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

	[0] = LAYOUT(
    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PSCR,  KC_SLCK,  KC_BRK,
    KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   __xxxx_,  KC_BSPC,  KC_INS,
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      __xxxx_,  KC_SPC,   __xxxx_,                      KC_RALT,LT(2,KC_APP), KC_RCTL,KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
